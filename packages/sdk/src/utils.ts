/** SHA-256 over raw bytes — browser and Node. Returns 32-byte Uint8Array. */
...
/** Read first 8 bytes of a params buffer as little-endian u64. Returns null if too short. */
