...
export class TranaGuardClient {
   ...
   * For Node.js test environments, use `registerTestPasskey()` from `@beharefe/sdk/testing`.
   *
   * Flow:
   ...
   * For Node.js test environments, use `buildTestProof()` from `@beharefe/sdk/testing`.
   *
   * Flow:
