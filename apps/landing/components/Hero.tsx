    ...
    <div className="hidden lg:block absolute right-12 bottom-12 w-[min(420px,38vw)] bg-[#0f1013] border border-white/[0.08] rounded-xl overflow-hidden font-mono shadow-[0_24px_60px_rgba(0,0,0,0.5),0_0_0_1px_rgba(255,255,255,0.02)]">
      <div className="flex items-center justify-between px-3.5 py-2.5 border-b border-white/[0.08] text-[11px] text-faint tracking-[0.04em]">
        <div className="flex gap-1.5">
          <i className="w-2 h-2 rounded-full not-italic" style={{ background: accent ?? "rgba(255,255,255,0.12)" }} />
...
function HeroFlow() {
  ...
  return (
    <div ref={containerRef} className="relative w-full h-[220px] sm:h-[260px]">
      {/* Stage labels */}
      <span className="absolute top-0 left-[8%] font-mono text-[10.5px] text-faint tracking-[0.14em]">01 · WALLET</span>
      <span className="absolute top-0 left-1/2 -translate-x-1/2 font-mono text-[10.5px] text-faint tracking-[0.14em]">02 · TRANA GUARD</span>
      <span className="absolute top-0 right-[8%] font-mono text-[10.5px] text-faint tracking-[0.14em]">03 · PROGRAM</span>
      ...
      <div ref={blockGlowRef}  className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[150px] h-[150px] rounded-full pointer-events-none" style={{ background: "radial-gradient(ellipse, rgba(255,85,96,0.20) 0%, transparent 70%)", opacity: 0 }} />
